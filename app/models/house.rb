...
class House < ActiveRecord::Base
    ...
    male = false
	    ...
	    if presun  && house != ""
	      ...
	      if flag == true
	        ...
	        msg += "Posláno narodu #{house.name} #{h_solar} solaru, #{h_material} kg, #{h_melange} mg, #{h_exp} exp, #{h_parts} dilu od naroda #{self.name}. Poslal #{posiela.nick}.  Poznamka : "+comment
	        self.zapis_operaci(msg)
		      house.zapis_operaci(msg)
		        ...
		        msg += "Posláno narodu #{house.name} #{h_solar} solaru, #{h_melange} mg a #{h_material} kg od naroda #{self.name}. Poslal #{posiela.nick}.  Poznamka : "+comment
		        self.zapis_operaci(msg)
    ...
    male = false
	    ...
	    if presun  && mr != ""
	      ...
	      if flag == true
	        ...
	        msg ="Posláno malorodu #{mr.name} #{mr_solar} solaru, #{mr_material} kg, #{mr_melange} mg, #{mr_exp} exp, #{mr_parts} dilu od naroda #{self.name}. Poslal #{posiela.nick}.  Poznamka : "+comment
	        self.zapis_operaci(msg)
    ...
    male = false
	    ...
	    if presun && user != ""
	      ...
	      if flag == true
	        ...
	        msg +="Posláno hraci #{user.nick} #{u_solar} solaru, #{u_material} kg, #{u_melange} mg, #{u_exp} exp, #{u_parts} dilu od naroda #{self.name}. Poslal #{posiela.nick}.  Poznamka : "+comment
	        self.zapis_operaci(msg)
  ...
  def posli_rodove_suroviny(h, u, mr, narod, user, malorod, posiela, comment)
