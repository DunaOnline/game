...
Unit.create(:name => 'Knížecí garda', :house_id => House.find_by_name('Moritani').id, :description => '', :attack => 5, :defence => 7, :health => 2, :equipment => 2, :material => 396, :solar => 916, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Assasin', :house_id => House.find_by_name('Moritani').id, :description => '', :attack => 8, :defence => 4, :health => 2, :equipment => 2, :material => 396, :solar => 916, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Kyborg', :house_id => House.find_by_name('Riches').id, :description => '', :attack => 10, :defence => 8, :health => 3, :equipment => 3, :material => 594, :solar => 1374, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Laserové dělo', :house_id => House.find_by_name('Riches').id, :description => '', :attack => 6, :defence => 18, :health => 4, :equipment => 1, :material => 783, :solar => 1823, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Slídič', :house_id => House.find_by_name('Vernio').id, :description => '', :attack => 4, :defence => 2, :health => 1, :equipment => 1, :material => 198, :solar => 458, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Štítonoši', :house_id => House.find_by_name('Vernio').id, :description => '', :attack => 3, :defence => 3, :health => 1, :equipment => 1, :material => 204, :solar => 464, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Imperiální garda', :house_id => House.find_by_name('Impérium').id, :description => '', :attack => 10, :defence => 5, :health => 3, :equipment => 1, :material => 507, :solar => 1167, :img => '', :lvl => nil, :druh => '')
