...
Unit.create(:name => 'Holtzmanův generátor',:salary => 26.85, :population => 5200, :house_id => 0, :description => 'Velice drahá vojenská mechanizace, která je schopna ochnánit celé legie či města.', :attack => 7, :defence => 20, :health => 1, :equipment => 2, :material => 831, :solar => 1931, :img => '', :lvl => 10, :druh => 'obr_technika')
