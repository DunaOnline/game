...
Unit.create(:name => 'Domobrana',:salary => 8.22, :house_id => 0, :population => 1644, :description => 'Základní jednotka chranící mnohá obydlí v Impériu.', :attack => 3, :defence => 4, :health => 1, :equipment => 0, :material => 225, :solar => 525, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Legie',:salary => 9.32, :house_id => 0, :population => 1600, :description => 'Páteř každé silné armády.', :attack => 4, :defence => 3, :health => 1, :equipment => 1, :material => 228, :solar => 528, :img => '', :lvl => 3, :druh => 'pechota')
Unit.create(:name => 'Raketomet',:salary => 35.07, :house_id => 0, :population => 6311, :description => 'Jednotka, schopná ničit celé legie vojáků a strojů.', :attack => 10, :defence => 18, :health => 4, :equipment => 2, :material => 906, :solar => 2106, :img => '', :lvl => 4, :druh => 'armada')
Unit.create(:name => 'Stíhací tank',:salary => 33.42, :house_id => 0, :population => 5511, :description => 'Nejrychlejší jednotka na bitevním poli.', :attack => 16, :defence => 8, :health => 3, :equipment => 3, :material => 684, :solar => 1584, :img => '', :lvl => 3, :druh => 'boj_technika')
Unit.create(:name => 'Landsraadni garda',:salary => 18.63, :house_id => 0, :population => 3333, :description => 'Elitní jednotky v Imperiu školené Ginázskými mistry meče. ', :attack => 5, :defence => 9, :health => 2, :equipment => 2, :material => 456, :solar => 1056, :img => '', :lvl => 3, :druh => 'obr_technika')
Unit.create(:name => 'Pozemní holtzmanův generátor',:salary => 26.85, :population => 5200, :house_id => 0, :description => 'Velice drahá vojenská mechanizace, která je schopna ochnánit celé legie či města.', :attack => 7, :defence => 20, :health => 1, :equipment => 2, :material => 831, :solar => 1931, :img => '', :lvl => 10, :druh => 'obr_technika')
Unit.create(:name => 'Sonický tank',:salary => 39.73, :house_id => House.find_by_name('Atreides').id, :population => 7000, :description => '', :attack => 18, :defence => 6, :health => 4, :equipment => 3, :material => 789, :solar => 1829, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Hradní stráž',:salary => 19.18, :house_id => House.find_by_name('Atreides').id, :population => 3667, :description => 'Univerzální národní jednotka vhodná pro boj i obranu.', :attack => 6, :defence => 6, :health => 2, :equipment => 1, :material => 393, :solar => 913, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Četa sardaukarů',:salary => 29.45, :house_id => House.find_by_name('Corrino').id, :population => 5611, :description => '', :attack => 9, :defence => 9, :health => 3, :equipment => 2, :material => 591, :solar => 1371, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Četa s bašárem',:salary => 38.36, :house_id => House.find_by_name('Corrino').id, :population => 7111, :description => '', :attack => 16, :defence => 8, :health => 4, :equipment => 2, :material => 786, :solar => 1826, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Vévodova garda',:salary => 20.55, :house_id => House.find_by_name('Ekaz').id, :population => 3722, :description => '', :attack => 4, :defence => 2, :health => 1, :equipment => 2, :material => 201, :solar => 461, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Mistři meče',:salary => 29.45, :house_id => House.find_by_name('Ekaz').id, :population => 5444, :description => '', :attack => 10, :defence => 8, :health => 3, :equipment => 2, :material => 591, :solar => 1371, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Devastátor',:salary => 50.00, :house_id => House.find_by_name('Harkonnen').id, :population => 8889, :description => '', :attack => 20, :defence => 10, :health => 5, :equipment => 4, :material => 987, :solar => 2287, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Halda ozbrojený otroků',:salary => 8.90,:house_id => House.find_by_name('Harkonnen').id, :population => 1889, :description => '', :attack => 2, :defence => 4, :health => 1, :equipment => 0, :material => 195, :solar => 455, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Garda Vimkomta',:salary => 20.55, :house_id => House.find_by_name('Moritani').id, :population => 3722, :description => 'Jednotka sloužicí k ochraně domovských světů.', :attack => 5, :defence => 7, :health => 2, :equipment => 2, :material => 396, :solar => 916, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Assasin',:salary => 20.55, :house_id => House.find_by_name('Moritani').id, :population => 3556, :description => 'Vyškolený zabiják zabijáků.', :attack => 8, :defence => 4, :health => 2, :equipment => 2, :material => 396, :solar => 916, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Kyborg',:salary => 30.82, :house_id => House.find_by_name('Riches').id, :population => 5444, :description => 'Elitní národní jednotka, která je určena pro pozemní boj.', :attack => 10, :defence => 8, :health => 3, :equipment => 3, :material => 594, :solar => 1374, :img => '', :lvl => nil, :druh => '')
Unit.create(:name => 'Laserové dělo',:salary => 36.99, :house_id => House.find_by_name('Riches').id, :population => 7611, :description => 'Není lepšího nástroje na porcování nepřátel!', :attack => 6, :defence => 18, :health => 4, :equipment => 1, :material => 783, :solar => 1823, :img => '', :lvl => nil, :druh => '')
