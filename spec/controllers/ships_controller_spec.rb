  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ship as @ship" do
        ...
        post :create, {:ship => { "name" => "invalid value" }}, valid_session
        assigns(:ship).should be_a_new(Ship)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ship" do
        ...
        Ship.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => ship.to_param, :ship => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ship as @ship" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ship.any_instance.stub(:save).and_return(false)
        put :update, {:id => ship.to_param, :ship => { "name" => "invalid value" }}, valid_session
        assigns(:ship).should eq(ship)
      end
